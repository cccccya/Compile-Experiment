...
/*Specifiers*/
Specifier: TYPE {$$=new NSpecifier(*(new std::string((char*)$1))); $$->line=yylineno;}   
        | StructSpecifier {$$=new NStructSpSpecifier(*$1); $$->line=$1->line;}   
        ;
...
VarDec:  ID {$$=new NVarDec(*(new NIdentifier($1))); $$->line=yylineno;}   //ID结点，标识符符号串存放结点的type_id
        | VarDec LB INT RB {$1->v.push_back($3); $$->line=$1->line;}
        ;
