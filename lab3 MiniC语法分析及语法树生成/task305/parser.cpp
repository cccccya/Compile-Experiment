...
{
       0,   110,   110,   112,   113,   115,   116,   117,   119,   120,
     124,   125,   128,   129,   132,   133,   136,   140,   141,   143,
     144,   146,   147,   149,   153,   155,   156,   158,   159,   160,
     161,   162,   163,   164,   168,   169,   171,   174,   175,   177,
     178,   182,   184,   185,   186,   187,   189,   190,   191,   192,
     194,   195,   196,   197,   198,   199,   200,   202,   204,   205,
...
#line 1686 "parser.cpp"
  ...
  case 10:
#line 124 "parser.y"
                {(yyval.nSpecifier)=new NSpecifier(*(new std::string((char*)(yyvsp[0].type_id)))); (yyval.nSpecifier)->line=yylineno;}
#line 1692 "parser.cpp"
    break;

  case 11:
#line 125 "parser.y"
                          {(yyval.nSpecifier)=new NStructSpSpecifier(*(yyvsp[0].nStructSpecifier)); (yyval.nSpecifier)->line=(yyvsp[0].nStructSpecifier)->line;}
#line 1698 "parser.cpp"
    break;

  case 12:
#line 128 "parser.y"
                                             {(yyval.nStructSpecifier)=new NStructSpecifier((yyvsp[-3].nOptTag),(yyvsp[-1].nDefList)); (yyval.nStructSpecifier)->line=(yyvsp[-4].line);}
#line 1704 "parser.cpp"
    break;

  case 13:
#line 129 "parser.y"
                     {(yyval.nStructSpecifier)=new NStructSpecifier((yyvsp[0].nTag)); (yyval.nStructSpecifier)->line=(yyvsp[-1].line);}
#line 1710 "parser.cpp"
    break;

  case 14:
#line 132 "parser.y"
           {(yyval.nOptTag)=new NOptTag(*(new NIdentifier((yyvsp[0].type_id)))); (yyval.nOptTag)->line=yylineno-1;}
#line 1716 "parser.cpp"
    break;

  case 15:
#line 133 "parser.y"
          {(yyval.nOptTag)=nullptr;}
#line 1722 "parser.cpp"
    break;

  case 16:
#line 136 "parser.y"
        {(yyval.nTag)=new NTag(*(new NIdentifier((yyvsp[0].type_id)))); (yyval.nTag)->line=yylineno;}
...
#line 1734 "parser.cpp"
  ...
  case 18:
#line 141 "parser.y"
                           {(yyvsp[-3].nVarDec)->v.push_back((yyvsp[-1].type_int)); (yyval.nVarDec)->line=(yyvsp[-3].nVarDec)->line;}
...
#line 1902 "parser.cpp"
  ...
  case 46:
#line 189 "parser.y"
                                         {(yyval.nExpression)=new NSingleOperator(*(new std::string("PLUSPLUS")),PLUSPLUS,*(yyvsp[0].nExpression)); (yyval.nExpression)->line=(yyvsp[-1].line);}
#line 1908 "parser.cpp"
    break;

  case 47:
#line 190 "parser.y"
                                             {(yyval.nExpression)=new NSingleOperator(*(new std::string("MINUSMINUS")),MINUSMINUS,*(yyvsp[0].nExpression)); (yyval.nExpression)->line=(yyvsp[-1].line);}
#line 1914 "parser.cpp"
    break;

  case 48:
#line 191 "parser.y"
                         {(yyval.nExpression)=new NSingleOperator(*(new std::string("PLUSPLUS")),PLUSPLUS,*(yyvsp[-1].nExpression)); (yyval.nExpression)->line=(yyvsp[-1].nExpression)->line;}
#line 1920 "parser.cpp"
    break;

  case 49:
#line 192 "parser.y"
                          {(yyval.nExpression)=new NSingleOperator(*(new std::string("MINUSMINUS")),MINUSMINUS,*(yyvsp[-1].nExpression)); (yyval.nExpression)->line=(yyvsp[-1].nExpression)->line;}
...
#line 1938 "parser.cpp"
  ...
  case 52:
#line 196 "parser.y"
                        {(yyval.nExpression)=new NBinaryOperator(*(new std::string("RELOP")),*(yyvsp[-2].nExpression),RELOP,*(yyvsp[0].nExpression)); (yyval.nExpression)->line=(yyvsp[-2].nExpression)->line;}
...
#line 1968 "parser.cpp"
  ...
  case 57:
#line 202 "parser.y"
                        {(yyval.nExpression)=new NBinaryOperator(*(new std::string("MOD")),*(yyvsp[-2].nExpression),MOD,*(yyvsp[0].nExpression)); (yyval.nExpression)->line=(yyvsp[-2].nExpression)->line;}
...
#line 1980 "parser.cpp"
  ...
  case 59:
#line 205 "parser.y"
                                   {(yyval.nExpression)=new NSingleOperator(*(new std::string("MINUS")),MINUS,*(yyvsp[0].nExpression)); (yyval.nExpression)->line=(yyvsp[-1].line);}
