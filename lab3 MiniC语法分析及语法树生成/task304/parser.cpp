...
{
       0,   106,   106,   108,   109,   111,   112,   113,   115,   116,
     120,   121,   124,   125,   128,   129,   132,   136,   137,   139,
     140,   142,   143,   145,   149,   151,   152,   154,   155,   156,
     157,   158,   159,   160,   164,   165,   167,   170,   171,   173,
     174,   178,   180,   181,   182,   183,   185,   186,   187,   188,
     190,   191,   192,   193,   194,   195,   196,   198,   200,   201,
...
#line 1689 "parser.cpp"
  ...
  case 11:
#line 121 "parser.y"
                          {(yyval.nSpecifier)=new NSpecifier(*(yyvsp[0].nStructSpecifier)); (yyval.nSpecifier)->line=(yyvsp[0].nStructSpecifier)->line;}
...
#line 1701 "parser.cpp"
  ...
  case 13:
#line 125 "parser.y"
                     {(yyval.nStructSpecifier)->line=(yyvsp[0].nIdentifier)->line;}
...
#line 1731 "parser.cpp"
  ...
  case 18:
#line 137 "parser.y"
                           {(yyval.nVarDec)->line=(yyvsp[-3].nVarDec)->line;}
#line 1737 "parser.cpp"
    break;

  case 19:
#line 139 "parser.y"
                         {(yyval.nFunDec)=new NFunDec(*(new NIdentifier((yyvsp[-3].type_id))),(yyvsp[-1].nVarList)); (yyval.nFunDec)->line=(yyvsp[-1].nVarList)->line;}
...
#line 1821 "parser.cpp"
  ...
  case 33:
#line 160 "parser.y"
                     {(yyval.nStmt)=new NBreakStmt(); (yyval.nStmt)=nullptr;}
...
#line 1899 "parser.cpp"
  ...
  case 46:
#line 185 "parser.y"
                                         {(yyval.nExpression)=new NSingleOperator(*(new std::string("PLUSPLUS")),PLUSPLUS,*(yyvsp[0].nExpression)); (yyval.nExpression)->line=(yyvsp[0].nExpression)->line;}
#line 1905 "parser.cpp"
    break;

  case 47:
#line 186 "parser.y"
                                             {(yyval.nExpression)=new NSingleOperator(*(new std::string("MINUSMINUS")),MINUSMINUS,*(yyvsp[0].nExpression)); (yyval.nExpression)->line=(yyvsp[0].nExpression)->line;}
...
#line 1971 "parser.cpp"
  ...
  case 58:
#line 200 "parser.y"
                        {(yyval.nExpression)=new NParenOperator(*(yyvsp[-1].nExpression)); (yyval.nExpression)->line=(yyvsp[-1].nExpression)->line;}
#line 1977 "parser.cpp"
    break;

  case 59:
#line 201 "parser.y"
                                   {(yyval.nExpression)=new NSingleOperator(*(new std::string("MINUS")),MINUS,*(yyvsp[0].nExpression)); (yyval.nExpression)->line=(yyvsp[0].nExpression)->line;}
#line 1983 "parser.cpp"
    break;

  case 60:
#line 202 "parser.y"
                        {(yyval.nExpression)=new NSingleOperator(*(new std::string("NOT")),NOT,*(yyvsp[0].nExpression)); (yyval.nExpression)->line=(yyvsp[0].nExpression)->line;}
